	...
	<div class="home-section">
	    <div class="home-content">
	      <i class='bx bx-menu'></i>
			...
			echo "</thead>";
			echo "<tbody>";
			$adm = listarAdministrador($conexao);
			$n = 1;
			...
			foreach($adm as $a){
				...
				echo '<td>'.$a["Login"].'</td>';
				echo '<td>'.$a["Tipo"].'</td>';
				echo '<td><a href="Editar-Administrador.php?IdAdmin='.$a["IdAdmin"].'"><i class="bx bx-edit-alt"></i></a></td>';
				echo '<td><a href="Excluir-Administrador.php?IdAdmin='.$a["IdAdmin"].'"><i class="bx bx-message-alt-x"></i></td></tr>';
				echo '</tr>';
				$n += 1;
			}
		echo "</tbody>";
