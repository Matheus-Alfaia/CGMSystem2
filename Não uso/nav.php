<nav class="navbar navbar-expand-lg navbar-blue bg" >
  <a class="navbar-brand" href="#"><img src="img/PicsArt_01-12-07.05.47.png" width="100px"></a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="organizador-cadastro.php">Cadastro Produto</a>
          <a class="dropdown-item" href="organizador-listar.php">Visualizar Produtos</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="cad_evento.php">Cadastro de Clientes</a>
          <a class="dropdown-item" href="eventos-listar.php">Visualisar Clientes</a>
          <!-- <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Something else here</a>
        </div> -->
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="categoria.php">Cadastro de Funcionario</a>
          <a class="dropdown-item" href="categoria-listar.php">Visualizar Funcionario</a>
          <!-- <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Something else here</a>
        </div> -->
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="categoria.php">Cadastro de Fornecedores</a>
          <a class="dropdown-item" href="categoria-listar.php">Visualizar Fornecedores</a>
          <!-- <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Something else here</a>
        </div> -->
      </li>
