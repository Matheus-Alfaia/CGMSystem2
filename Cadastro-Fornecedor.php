	      ...
	      <i class='bx bx-menu'></i>
			...
			if(!isset($_GET['cadastro'])){
				echo "<div class='letter-normal'>";
					echo "<h1>Cadastro Fornecedor</H1>";
				echo "</div>";
					...
					echo "<div class='card-cadastro'>";
						...
						echo "<legend>Geral</legend>";
							...
							echo '<input type="text" class="controle-nome" name="nome" autocomplete="off" required>';
								echo "<br>";
							echo '<textarea rows="10" cols="140" placeholder="Descrição" name="desc"></textarea>';
						echo '</fieldset>';
				...
				$cadastro = cadastrarFornecedor($conexao, $nome, $descricao);
